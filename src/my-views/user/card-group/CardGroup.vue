<template>
    <div>
        ...
        <div class="margin-container layout-flex tree-edit">

            <el-card>
                <div class="layout-flex flex-align-center">
                    <div class="margin-right-sm"><h3>卡片组</h3></div>
...
<script>
    ...
    export default {
            ...
            return {
                ...
                formOption: {
                    column: [{
                        ...
                        type: "radio",
                        value: 'DISABLE',
                        dicData: this.$store.state.constants.dictList['CardGroup_TaskType'],
                        mock: {
                            type: 'dic'
                        }
                    },
        ...
        methods: {
            ...
            async clickDel() {
                const rep = await this.$api.genApi.CardGroupApi.remove({ids: this.checkedKeys})
                this.updateList()
            },
            clickSaveForm(form, done, loading) {
                ...
                this.$api.genApi.CardGroupApi.save(temp).then(rep => {
